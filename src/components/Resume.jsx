                    ...
                    <div className="resume__section animate-in">
                        ...
                        <div className="resume__exp-list">
                            {[
                                ...
                                { company: 'ML RESEARCH PROJECT', role: 'Student Researcher', period: '2024', desc: 'Developed a machine learning model for predictive analytics using Python, scikit-learn, and TensorFlow. Achieved high accuracy on real-world datasets through feature engineering and hyperparameter tuning.' },
                                { company: 'AI APPLICATIONS', role: 'Personal Projects', period: '2024', desc: 'Built intelligent applications leveraging NLP, computer vision, and deep learning frameworks. Explored real-world AI use cases including chatbots and image classification.' },
                                ...
                                { company: 'OPEN SOURCE', role: 'Contributor', period: '2023 – Present', desc: 'Active contributor to open-source projects on GitHub. Focused on Python libraries, data tools, and developer utilities. Passionate about collaborative coding.' },
                            ].map((exp, i) => (
